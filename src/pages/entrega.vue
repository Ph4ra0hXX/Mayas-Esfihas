...
export default {
  setup() {
    ...
    function finalizarPedido() {
      ...
      // Adaptação para incluir todos os itens do carrinho, inclusive esfirras
      const categorias = [
        { key: "burgers", label: "*Burger*" },
        { key: "esfirras", label: "*Esfirras*" },
        { key: "macarronadas", label: "*Macarronada*" },
      ...
      categorias.forEach((cat) => {
        const dados = this.carrinho[cat.key];
      ...
      if (this.carrinho.dadosPessoais.formaDeEntrega == "Vou buscar") {
        if (this.carrinho.dadosPessoais.nome != "") {
          ...
          window.location.href = `https://wa.me/5588996639716?text=${this.pedidoMontado}`;
        } else {
