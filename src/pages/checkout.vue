...
export default {
  setup() {
    ...
    const esfirras = ref([...carrinho.esfirras]);
    ...
    function removerPedidoEsfirras(index) {
      this.carrinho.esfirras.splice(index, 1);
      this.notificacaoRemoverPedido();
    }

    function removerItemEsfirras(pedidoIndex, secao, itemIndex) {
      this.carrinho.esfirras[pedidoIndex][secao].splice(itemIndex, 1);
    }

    function aumentarQuantidadeEsfirras(pedidoIndex, secao, itemIndex) {
      this.carrinho.esfirras[pedidoIndex][secao][itemIndex].quantidade++;
    }

    function diminuirQuantidadeEsfirras(pedidoIndex, secao, itemIndex) {
      if (
        this.carrinho.esfirras[pedidoIndex][secao][itemIndex].quantidade > 0
      ) {
        this.carrinho.esfirras[pedidoIndex][secao][itemIndex].quantidade--;
      }

      this.carrinho.esfirras = removeObjetosSeQuantidadeZero(
        this.carrinho.esfirras
      );
    }
    ...
    return {
      ...
      mensagemDeRemover,
      removerPedidoEsfirras,
      removerItemEsfirras,
      aumentarQuantidadeEsfirras,
      diminuirQuantidadeEsfirras,
...
<template>
  <div class="paypal">
    ...
    <div class="paypal__cart">
      ...
      <div
        id="pedidoFundo"
        v-for="(pedido, pedidoIndex) in carrinho.esfirras"
        :key="pedidoIndex"
      >
            ...
            <template v-if="item.quantidade > 0">
              <div id="priceAndDiv">
                ...
                <div>
                  <button
                    @click="
                      aumentarQuantidadeEsfirras(pedidoIndex, secao, itemIndex)
                    "
                    class="botao1"
                  >
                    +
                  ...
                  <button
                    @click="
                      diminuirQuantidadeEsfirras(pedidoIndex, secao, itemIndex)
                    "
                    class="botao2"
                  >
                    -
        ...
        <button id="butDelete" @click="removerPedidoEsfirras(pedidoIndex)">
          Remover Pedido
        </button>
        <br />
        <br />
